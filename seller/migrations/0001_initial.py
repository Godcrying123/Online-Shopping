    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(choices=[{'normal', 1}, {0, 'deleted'}, {2, 'banned'}, {3, 'VIP'}], default=1, verbose_name='status')),
                ('delivery_out_address', models.CharField(db_index=True, max_length=200)),
